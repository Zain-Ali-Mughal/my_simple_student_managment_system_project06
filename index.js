...
class Student {
    ...
    id;
    name;
    courses; // Initializing an empty array of courses.
    balance;
    ...
    viewBalance() {
        ...
        console.log(chalk.bgBlue.white.bold(`Balance for ${this.name}: $${this.balance}`));
        console.log("-".repeat(50));
    }
    ...
    payTuitionFee(amount) {
        ...
        console.log("-".repeat(50));
        console.log(chalk.green.bold(`$${amount} fees paid successfully for ${this.name}`));
...
class StudentManager {
    ...
    enrollStudent(studentId, course) {
        ...
        if (student) {
            ...
            console.log("-".repeat(50));
            console.log(chalk.green.bold(`Student ${student.name} enrolled in ${course}`));
            console.log("-".repeat(50));
        }
        else {
            console.log("-".repeat(50));
    ...
    // Method to pay tuition fee.
    payTuitionFee(studentId, amount) {
        let student = this.findStudentById(studentId);
        if (student) {
    ...
    while (true) {
        ...
        switch (choice.choice) {
            ...
            case "Pay Tuition Fee": {
                ...
                studentManager.payTuitionFee(parseInt(feeInput.studentId), parseFloat(feeInput.amount));
                break;
            }
            case "Show Details": {
